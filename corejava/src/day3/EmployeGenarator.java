...
public class EmployeGenarator {
	...
	public void nameGenertor() {
		...
		String inputChar = "abcdefghijklmnopqrsetuvwxyz";
		String firstname = "";
	...
	public static void main(String[] args) {
		EmployeGenarator e1 = new EmployeGenarator();
		e1.details();
		EmployeGenarator e2 = new EmployeGenarator();
		e2.details();
